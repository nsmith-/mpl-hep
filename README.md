...
This package will eventually be installable mpl-hep like any other Python package:
...
====================
   ...
   - [Python](http://docs.python-guide.org/en/latest/starting/installation/) (2.7+, 3.6+)
